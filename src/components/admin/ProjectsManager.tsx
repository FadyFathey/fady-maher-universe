...
import { Plus, Edit, Trash2, ExternalLink, Github, Calendar, Eye, EyeOff } from 'lucide-react';
...
const ProjectsManager = () => {
  ...
  const toggleVisibilityMutation = useMutation({
    ...
    onSuccess: ({ projectId, visible }) => {
      queryClient.setQueryData<Project[] | undefined>(['admin-projects'], (current) =>
        current?.map((project) =>
          project.id === projectId ? { ...project, visible } : project
        )
      );
      ...
      toast({
        title: "Success",
        description: `Project is now ${visible ? 'visible' : 'hidden'} on the public site.`,
      });
    },
    onError: () => {
      toast({
                ...
                <div className="flex items-start justify-between">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-4 text-sm text-muted-foreground">
                      ...
                      <Badge variant={project.visible === false ? "destructive" : "default"}>
                  ...
                  <div className="flex items-center space-x-2">
                    <Button
                      ...
                      title={project.visible === false ? "Show project" : "Hide project"}
                    >
